...
function set(options) {
  ...
  console.log('options.imagemagick', options.imagemagick);
...
function getGm() {
  ...
  console.log('useImagemagick', useImagemagick);
  console.log('gmExists', gmExists);
  if (useImagemagick || (useImagemagick === undefined && !gmExists)) {
    console.log('returnSubclass');
    return _gm.subClass({ imageMagick: true });
  } else {
    console.log('NOPEsubclass');
    return _gm;
  }
}
